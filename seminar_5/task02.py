...
#     print (f'Всего конфет: {residue_candy}  Первый игрок {name_gamer_first}: {first_gamer_candy} Второй игрок {name_gamer_second}: {second_gamer_candy}')
#     while residue_candy>0:
#         get_first_gamer_candy = get_candy(name_gamer_first,residue_candy)
#         if get_first_gamer_candy > 0:
#             first_gamer_candy += get_first_gamer_candy
#             residue_candy -= get_first_gamer_candy
#             if residue_candy == 0:
#                 leader = name_gamer_first
#             break
#         print('Ошибка, повторите ввод')
#     os.system('cls')
#     print (f'Всего конфет: {residue_candy}  Первый игрок {name_gamer_first}: {first_gamer_candy} Второй игрок {name_gamer_second}: {second_gamer_candy}')
#     while residue_candy>0:
#         get_second_gamer_candy = get_candy(name_gamer_second,residue_candy)
#         if get_second_gamer_candy > 0:
#             second_gamer_candy += get_second_gamer_candy
#             residue_candy -= get_second_gamer_candy
#             if residue_candy == 0:
#                 leader = name_gamer_second
#             break
#         print('Ошибка, повторите ввод')
#     os.system('cls')
# else:
